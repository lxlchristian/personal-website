...
const TRANSLATIONS = {
  ...
  en: {
    ...
    /* ── Homepage ── */
    'home.subtitle': 'Music for stories on stage and screen.',
    ...
    'track.game.Strategy':         'Strategy',
    'track.game.Action Sidescroller': 'Action Sidescroller',
    'track.game.Exploration':      'Exploration',
    ...
    'track.genre.Electronic / Rock':      'Electronic / Rock',
    'track.genre.Electronic Hybrid':      'Electronic Hybrid',
  ...
  zh: {
    ...
    'track.game.Strategy':         '策略游戏',
    'track.game.Action Sidescroller': '横版动作游戏',
    'track.game.Exploration':      '探索游戏',
    'track.game.Dating Simulator': '恋爱模拟器',
    'track.game.Bullet Hell':      '弹幕射击',
    'track.game.Speed Platformer': '速度平台游戏',
    'track.game.Rhythm Battler':   '节奏格斗',
    'track.game.Retro':            '复古游戏',
    'track.genre.Cinematic / Orchestral': '电影风格 / 管弦乐',
    'track.genre.Electronic / Rock':      '电子音乐 / 摇滚',
    'track.genre.Electronic Hybrid':      '电子混合',
    ...
    'bio.p3': '我还发行了《心之岛》的17首完整原声带，并为动作肉鸽游戏《太吾绘卷》制作了宣传片配乐——该视频在哔哩哔哩播放量突破120万次。此外，我通过伯克利音乐学院游戏与互动配乐项目与众多开发者深度合作，并分别在东京索尼PlayStation及北京LEAP工作室完成实习。',
  ...
  ja: {
    ...
    /* ── Homepage ── */
    'home.subtitle': '舞台とスクリーン、物語のための音楽。',
    ...
    'track.game.Strategy':         'ストラテジー',
    'track.game.Action Sidescroller': '横スクロールアクション',
    'track.game.Exploration':      '探索',
    ...
    'track.genre.Electronic / Rock':      'エレクトロニック / ロック',
    'track.genre.Electronic Hybrid':      'エレクトロニック・ハイブリッド',
    ...
    'bio.p3': 'ゲーム音楽では、オリジナルサウンドトラック『アイランド・オブ・ハーツ』（全17曲）を制作しました。さらに担当した『太吾絵巻』PVは、Bilibiliで120万回以上再生されるなど、大きな反響を獲得しています。バークリー音楽院のGames and Interactive Scoring Programを通じて世界中の開発者と協働し、ソニー・インタラクティブエンタテインメント（東京）およびLEAP Studio（北京）でのインターンシップも経験。国際的な現場で実践を重ねてきました。',
